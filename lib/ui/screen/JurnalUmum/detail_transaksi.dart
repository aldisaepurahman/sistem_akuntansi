...
class DetailTransaksi extends StatefulWidget {
  ...
  const DetailTransaksi({required this.client, required this.bulan, required this.tahun, required this.id_jurnal, required this.transaksi, Key? key}) : super(key: key);
