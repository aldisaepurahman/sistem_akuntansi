...
class TransaksiList extends StatefulWidget {
  ...
  const TransaksiList({required this.client, required this.bulan, required this.tahun, required this.id_jurnal, Key? key}) : super(key: key);
                              ...
                              children: [
                                ...
                                ButtonNoIcon(
                                    ...
                                    onPressed: (){
                                      ...
                                      var nomor_bukti = (_case == 1 ? no_bukti.text : no_bukti_update.text);
                        ...
                        BlocConsumer<VJurnalBloc, SiakState>(
                            ...
                            listener: (_, state) {
                              if (state is SuccessState) {
                                ...
                                list_transaksi = mappings(temp_list_transaksi);
