...
class JenisJurnalPenyesuaian extends StatefulWidget {
  const JenisJurnalPenyesuaian({required this.client, Key? key}) : super(key: key);
...
class JenisJurnalPenyesuaianState extends State<JenisJurnalPenyesuaian> {
  ...
  void _navigateToDaftarTransaksiPenyesuaian(BuildContext context) {
  ...
  void initState() {
    ...
    tableRow = new JenisJurnalTableData(
      ...
      seeDetail: (){
        _navigateToDaftarTransaksiPenyesuaian(context);
      },
      editForm: () {
        showForm();
      },
